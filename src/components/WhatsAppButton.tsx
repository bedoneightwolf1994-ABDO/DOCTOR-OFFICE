'use client'
// Floating WhatsApp button shown on every public page, with a small
// attention-grabbing "Contact Us Now" label above it.
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      <a
        ...
        className="bg-navy-950 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-md animate-pulse hover:animate-none"
      >
        Contact Us Now
      </a>
      <a
        ...
        className="flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebd5a] text-white rounded-full shadow-lg px-4 py-3.5 transition-transform hover:scale-105"
      >
